<template>
    <v-expansion-panels
      ...
      <v-expansion-panel
        ...
        value="private"
        v-if="filteredPrivateConstructions && filteredPrivateConstructions.length > 0">
        <v-expansion-panel-title>
          {{ t('privateConstructions') }} ({{ filteredPrivateConstructions.length }})
        </v-expansion-panel-title>
      ...
      <v-expansion-panel
        value="starred"
        v-if="filteredStarredConstructions && filteredStarredConstructions.length > 0">
        <v-expansion-panel-title>
          {{ t('starredConstructions') }} ({{ filteredStarredConstructions.length }})
        </v-expansion-panel-title>
        <v-expansion-panel-text>
          <ConstructionList
      ...
      <v-expansion-panel
        value="public"
        v-if="filteredPublicConstructions && filteredPublicConstructions.length > 0">
        <v-expansion-panel-title>
          {{ t('publicConstructions') }} ({{ filteredPublicConstructions.length }})
        </v-expansion-panel-title>
        <v-expansion-panel-text>
          <ConstructionList
